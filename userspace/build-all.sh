...
ARCH_TABLE=(
  ...
  [sh4]="sh|sh|sh4-linux-|sh-linux-musl|rts7751r2dplus_defconfig|arch/sh/boot/zImage"
...
QEMU_CMD=(
  ...
  [mips64]="qemu-system-mips64 -M malta -cpu MIPS64R2-generic -m 1G -nographic -no-reboot"
  [m68k]="qemu-system-m68k -M virt -m 512M -nographic -no-reboot"
  [or1k]="qemu-system-or1k -M virt -m 128M -nographic -no-reboot"
  [microblaze]="qemu-system-microblaze -M petalogix-s3adsp1800 -m 256M -nographic -no-reboot"
